...
import 'package:nutrition/widget/rounded_button.dart';
import 'package:nutrition/widget/text.dart';
import 'package:nutrition/widget/text_field.dart';
                      ...
                      child: Column(
                          ...
                          children: <Widget>[
                              ...
                              Row(mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                              TextWidget(text: 'Weight', fontsize: 18,fontWieght: FontWeight.w300,),
                              Padding(
                                padding: const EdgeInsets.only(left: 10,right: 10),
                                child: TextFieldWidget(controller: controller1),
                              ),
                              TextWidget(text: 'kg', fontsize: 15,fontWieght: FontWeight.w400),
                            ],
                          ),
                            SizedBox(
                              height: 15,
                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Padding(
                                  ...
                                  child: TextWidget(text: 'Height', fontsize: 18,fontWieght: FontWeight.w300),
                                ),
                                TextFieldWidget(controller: controller2),
                                Padding(
                                  padding: const EdgeInsets.only(left: 10),
                                  child: TextWidget(text: 'cm', fontsize: 15,fontWieght: FontWeight.w400),
                                ),
                              ],
                            ),
                              ...
                              children: [
                                Column(
                                  children: [
                                    ...
                                    TextWidget(text: 'Protein', fontsize: 15,fontWieght: FontWeight.bold),
                                  ],
                                ),
                                Column(
                                  children: [
                                    ...
                                    TextWidget(text: 'Calories', fontsize: 15,fontWieght: FontWeight.bold),
                                  ],
                                ),
                              ],
                            ),
                              ...
                              children: [
                                Column(
                                  children: [
                                    ...
                                    TextWidget(
                                        text: 'Grams of Carbs', fontsize: 15,fontWieght: FontWeight.bold),
                                  ],
                                ),
                                Column(
                                  children: [
